               ...
               <div class="card-body"  style="margin-bottom: 40px; padding-bottom: 80px;" >
                 ...
                 <?php
                   ...
                   ?>
                    ...
                    <center><input type="submit" id="btnUpdateQuestion" class="btn btn-success btnUpdate" value='CẬP NHẬT CÂU HỎI' style="margin-top: 20px;">
                  <?php 
                    if($check==1){
                  ?>
                    <button id="btnCheckQuestion" class="btn btn-success btnCheck" style="margin-top:20px;">DUYỆT </button></center>
