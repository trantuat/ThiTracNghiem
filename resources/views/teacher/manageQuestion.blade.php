...
@endif
        ...
        <div class="">
          ...
          <div class="row">
             <div class="col-sm-11">
              ...
              <div class="col-sm-1">
                <button  class="btn btn-danger" data-toggle='modal' title='Add new question' data-target='#addQuestion' onclick="loadSubject()"><b><i class="fa fa-plus"></i></b></button>
              </div>
            </div>
  ...
  <!--ADD NEW QUESTION-->
    <div class="modal fade" id="addQuestion" role="dialog">
      <div class="modal-dialog modal-lg" style="width:1000px;max-width: 80%;">
         <!-- Modal content-->
         <div class="modal-content">
            <form id="formAddQuestion" method="" class="form-horizontal" >
            {{ csrf_field() }}
                <div class="modal-header">
                  <h4 class="modal-tittle">CÂU HỎI MỚI</h4>
               ...
               <div class="modal-body" >
                  ...
                  <div class="modal-body-answer">
                      ...
                      <div class="input-group" style="margin-bottom:30px;">
                          <button  name="addAnswer" id="addAnswer" class="btn btn-primary" style="position: absolute; right: 0;">More answers</button> 
                      </div>
                    </div>
                    
              </div>
             <div class="modal-footer">
                <input type="submit" id="btnAddQuestion" class="btn btn-success btnAdd" value='Add'>
