...
<html lang="en">
  ...
  <body>
	<div class="register" >
		<div class="top">
			<h1 id="title" class="hidden"><span id="logo">Chào Mừng </span></h1>
		</div>
		<div class="login-box animated fadeInUp" style="margin-bottom:20px;">
      ...
      {!! csrf_field() !!}
        ...
        <div class="form-group" style="margin-left:10px; margin-right:10px;">
          <div class="form-row">
              <label class="col-md-2"><b>Vai trò</b></label>
              <label class="col-md-5 radio-inline"><input type="radio" name="role" id="1" value  = "1" checked> Học Sinh</label>
              <label class="col-md-5 radio-inline"><input type="radio" name="role" id="2" value = "2" > Giáo viên</label>
          </div>
        </div>
        <center><input type="submit" class="btn btn-block col-sm-4" value="Đăng ký"></center>
      </form>
